...
def index(request):
    ...
    # with open('tk.json') as tk:
    #     tk_dict = json.load(tk)
    error = ''
...
class BaseAPIView(APIView):
    def post(self, request):
        ...
        data_str = str(data)
        data_dict = dict(data)
        # data_dict = {'menu': {'id': 682, 'date': '24.06.2022', 'status': 'completed', 'completed_at': '22.06.2022 17:52:31',
        ...
        #                              'energy': '191.51808', 'image': 'a8faed5c-fd3e-40cf-bb93-6d86240a268e.jpg',
        #                              'vegan': 0, 'allergens': 0, 'lactose_free': 0, 'sugarless': 0, 'gluten_free': 0,
        #                              'description': ''}, 'category': {'id': 6, 'name': 'Вторые блюда'}},
        #                 {'id': 13277, 'combo': False,
        #                  'product': {'id': 337, 'name': 'Куриная ватрушка с грибным жульеном 120 гр.', 'price': 159,
        #                              'carbohydrate': '23.04720', 'fat': '17.42760', 'fiber': '20.17560',
        #                              'energy': '329.73120', 'image': '66366171-300e-469f-8692-de7da76785f4.jpg',
        #                              'vegan': 0, 'allergens': 0, 'lactose_free': 0, 'sugarless': 0, 'gluten_free': 0,
        ...
        #                  'category': {'id': 6, 'name': 'Вторые блюда'}}, {'id': 13278, 'combo': False,
        #                                                                   'product': {'id': 396,
        #                                                                               'name': 'Перец фаршированный овощами, грибами и кус-кусом 200/50',
        #                                                                               'price': 239,
        #                                                                               'carbohydrate': '25.70250',
        #                                                                               'fat': '8.97750',
        #                                                                               'fiber': '4.95250',
        #                                                                               'energy': '203.40750',
        #                                                                               'image': '7bba3000-acb3-4b5d-aecd-aa0b7be477e5.jpg',
        #                                                                               'vegan': 0, 'allergens': 0,
        ...
        #                                                                                'name': 'Вторые блюда'}},
        #                 {'id': 13279, 'combo': True,
        #                  'product': {'id': 1817, 'name': 'Суп-крем овощной 250 гр.', 'price': 99,
        #                              'carbohydrate': '21.50694', 'fat': '5.40708', 'fiber': '2.86319',
        #                              'energy': '146.14958', 'image': 'fb998852-3579-4a9a-bba7-abe5cccb8f32.jpg',
        #                              'vegan': 0, 'allergens': 0, 'lactose_free': 0, 'sugarless': 0, 'gluten_free': 0,
        ...
        #                  'category': {'id': 17, 'name': 'Первые блюда'}}, {'id': 13280, 'combo': False,
        #                                                                    'product': {'id': 1255,
        #                                                                                'name': 'Тайский суп с лапшой и говядиной 250 гр.',
        #                                                                                'price': 169,
        #                                                                                'carbohydrate': '17.91500',
        #                                                                                'fat': '14.48250',
        #                                                                                'fiber': '15.07500',
        #                                                                                'energy': '262.29000',
        #                                                                                'image': '76113578-d361-41f9-9bad-31a37e26c856.jpg',
        #                                                                                'vegan': 0, 'allergens': 0,
        #                                                                                'lactose_free': 0,
        #                                                                                'sugarless': 0, 'gluten_free': 0,
        ...
        #                                                                    'category': {'id': 17,
        #                                                                                 'name': 'Первые блюда'}},
        #                 {'id': 13281, 'combo': False,
        #                  'product': {'id': 434, 'name': 'Стейк из бедра индейки с томатной сальсой 100/50 гр.',
        #                              'price': 239, 'carbohydrate': '3.64950', 'fat': '16.14150', 'fiber': '21.92400',
        #                              'energy': '247.57050', 'image': 'df5fb311-1b7f-4373-bc4d-2ca869c8b3e7.jpg',
        #                              'vegan': 0, 'allergens': 0, 'lactose_free': 0, 'sugarless': 0, 'gluten_free': 0,
        ...
        #                  'category': {'id': 6, 'name': 'Вторые блюда'}}, {'id': 13282, 'combo': True,
        #                                                                   'product': {'id': 446,
        #                                                                               'name': 'Тефтели куриные с зеленым горошком в сметанном соусе 100/50гр.',
        #                                                                               'price': 139,
        #                                                                               'carbohydrate': '16.39800',
        #                                                                               'fat': '12.20250',
        #                                                                               'fiber': '14.38200',
        #                                                                               'energy': '232.92450',
        #                                                                               'image': '1b066181-48e5-4739-b847-6819afa21f54.jpg',
        #                                                                               'vegan': 0, 'allergens': 0,
        #                                                                               'lactose_free': 0, 'sugarless': 0,
        #                                                                               'gluten_free': 0,
        ...
        #                                                                   'category': {'id': 6,
        #                                                                                'name': 'Вторые блюда'}},
        #                 {'id': 13283, 'combo': False,
        #                  'product': {'id': 514, 'name': 'Брокколи на пару с болгарским перцем 150 гр.', 'price': 119,
        #                              'carbohydrate': '7.41150', 'fat': '5.26650', 'fiber': '3.73650',
        #                              'energy': '91.98150', 'image': '0f3a5af0-8454-4441-a5f6-c53655b1b2b3.jpg',
        #                              'vegan': 1, 'allergens': 0, 'lactose_free': None, 'sugarless': None,
        #                              'gluten_free': None,
        #                              'description': 'Состав:Капуста брокколи с/м, перец болгарский, масло подсолнечное'},
        #                  'category': {'id': 9, 'name': 'Гарниры'}}, {'id': 13284, 'combo': True, 'product': {'id': 617,
        #                                                                                                      'name': 'Спагетти отварные 150 гр.',
        #                                                                                                      'price': 69,
        #                                                                                                      'carbohydrate': '35.74950',
        #                                                                                                      'fat': '7.15650',
        #                                                                                                      'fiber': '4.68000',
        #                                                                                                      'energy': '226.12350',
        #                                                                                                      'image': '66149542-2a5f-426e-9e58-bf327a581b76.jpg',
        #                                                                                                      'vegan': 1,
        #                                                                                                      'allergens': 0,
        #                                                                                                      'lactose_free': None,
        #                                                                                                      'sugarless': None,
        ...
        #                 {'id': 13285, 'combo': False,
        #                  'product': {'id': 359, 'name': 'Лазанья грибная 200 гр.', 'price': 199,
        #                              'carbohydrate': '56.29400', 'fat': '14.49800', 'fiber': '19.03600',
        #                              'energy': '431.79400', 'image': 'f82d609c-7824-4492-b297-a0616726f9cb.jpg',
        #                              'vegan': 0, 'allergens': 0, 'lactose_free': 0, 'sugarless': 0, 'gluten_free': 0,
        ...
        #                  'category': {'id': 6, 'name': 'Вторые блюда'}}, {'id': 13286, 'combo': False,
        #                                                                   'product': {'id': 1218,
        #                                                                               'name': 'Суп рисовый с куриными фрикадельками 250 гр.',
        #                                                                               'price': 89,
        #                                                                               'carbohydrate': '10.14000',
        #                                                                               'fat': '4.60750',
        #                                                                               'fiber': '6.47750',
        #                                                                               'energy': '107.94000',
        #                                                                               'image': 'dd6bbb7a-d17c-4725-b8b8-2da02e2012db.jpg',
        #                                                                               'vegan': 0, 'allergens': 0,
        #                                                                               'lactose_free': 0, 'sugarless': 0,
        #                                                                               'gluten_free': 0,
        ...
        #                                                                   'category': {'id': 17,
        #                                                                                'name': 'Первые блюда'}},
        #                 {'id': 13287, 'combo': False,
        #                  'product': {'id': 508, 'name': ' Картофельное пюре со шпинатом150 гр.', 'price': 89,
        #                              'carbohydrate': '26.91450', 'fat': '7.95750', 'fiber': '4.05450',
        #                              'energy': '195.50250', 'image': 'ee560f38-5b7b-41f8-8275-a4a2b3e7f8b1.jpg',
        #                              'vegan': 0, 'allergens': 0, 'lactose_free': 0, 'sugarless': 0, 'gluten_free': 0,
        #                              'description': 'Состав: Картофель,молоко,масло сливочное,шпинат с/м.,соль'},
        #                  'category': {'id': 9, 'name': 'Гарниры'}}, {'id': 13288, 'combo': False,
        #                                                              'product': {'id': 1642,
        #                                                                          'name': 'Рис с укропом150 гр.',
        #                                                                          'price': 69,
        #                                                                          'carbohydrate': '47.23619',
        #                                                                          'fat': '4.42347', 'fiber': '3.91797',
        #                                                                          'energy': '241.06339',
        #                                                                          'image': 'fb9a613c-3095-4a6b-a194-5a695b628b90.jpg',
        #                                                                          'vegan': 0, 'allergens': 0,
        #                                                                          'lactose_free': 0, 'sugarless': 0,
        #                                                                          'gluten_free': 0,
        #                                                                          'description': 'Cостав:Рис,шпинат,масло раст.,специи'},
        #                                                              'category': {'id': 9, 'name': 'Гарниры'}},
        #                 {'id': 13289, 'combo': False,
        #                  'product': {'id': 927, 'name': 'Салат "Столичный" с курицей 100 гр.', 'price': 89,
        #                              'carbohydrate': '5.98515', 'fat': '9.44750', 'fiber': '6.03912',
        #                              'energy': '133.12458', 'image': '298406ab-7fd7-4b54-8c47-ac94ea3ac828.jpg',
        #                              'vegan': 0, 'allergens': 0, 'lactose_free': 0, 'sugarless': 0, 'gluten_free': 0,
        ...
        #                  'category': {'id': 15, 'name': 'Салаты'}}, {'id': 13290, 'combo': False, 'product': {'id': 947,
        #                                                                                                       'name': 'Салат из крабовых палочек 100 гр.',
        #                                                                                                       'price': 89,
        #                                                                                                       'carbohydrate': '5.40000',
        #                                                                                                       'fat': '9.16500',
        #                                                                                                       'fiber': '2.91000',
        #                                                                                                       'energy': '115.72500',
        #                                                                                                       'image': '606430d1-cf3b-4d6d-ac82-050ed6bf6bd0.jpg',
        #                                                                                                       'vegan': 0,
        #                                                                                                       'allergens': 0,
        #                                                                                                       'lactose_free': 0,
        #                                                                                                       'sugarless': 0,
        ...
        #                 {'id': 13291, 'combo': False,
        #                  'product': {'id': 992, 'name': 'Салат из томатов с редисом 100 гр.', 'price': 109,
        #                              'carbohydrate': '3.58000', 'fat': '5.16000', 'fiber': '0.80500',
        #                              'energy': '63.98000', 'image': '1c25edbd-0443-4865-a7e0-ba0c9417e44f.jpg',
        #                              'vegan': 0, 'allergens': 0, 'lactose_free': 0, 'sugarless': 0, 'gluten_free': 0,
        #                              'description': 'Состав:Помидоры свежие, редис, укроп, масло раст., соль.'},
        #                  'category': {'id': 15, 'name': 'Салаты'}}, {'id': 13292, 'combo': True, 'product': {'id': 976,
        #                                                                                                      'name': 'Салат из свежей капусты с зеленым горошком 100 гр.',
        #                                                                                                      'price': 79,
        #                                                                                                      'carbohydrate': '4.82248',
        #                                                                                                      'fat': '7.27273',
        #                                                                                                      'fiber': '2.26123',
        #                                                                                                      'energy': '93.78938',
        #                                                                                                      'image': '5f3ea239-a7b2-47e8-9de5-3ca456a6e175.jpg',
        #                                                                                                      'vegan': 1,
        #                                                                                                      'allergens': 0,
        #                                                                                                      'lactose_free': None,
        #                                                                                                      'sugarless': None,
        ...
        #                                                              'category': {'id': 15, 'name': 'Салаты'}},
        #                 {'id': 13293, 'combo': False,
        #                  'product': {'id': 958, 'name': 'Салат из огурцов с укропом 100 гр.', 'price': 89,
        #                              'carbohydrate': '2.87000', 'fat': '2.12600', 'fiber': '0.86200',
        #                              'energy': '34.06200', 'image': 'cc924895-5a6e-49d3-b344-13173340541a.jpg',
        #                              'vegan': 1, 'allergens': None, 'lactose_free': None, 'sugarless': None,
        #                              'gluten_free': None,
